...
import { Search, Sparkles, Paintbrush, Layers, Plane, Gift, CreditCard, Gamepad2, Image as ImageIcon, Bot, Globe, ChevronLeft, ChevronRight } from 'lucide-react';
...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const tabs = [
    ...
    { id: 'zombie' as TabType, label: t.tabZombie, icon: Plane, badge: 'AIR' },
